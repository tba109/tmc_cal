...
def main():
    ...
    # November 17, 2016 (LM399A, only ADC0 CH0 and CH1, remove distribution boards, PGA=1 for all, short both channels)
    tmc_file = '../../tmc_cal_data/tmeas_2016-11-18_13_00_42_624590.txt'
    ...
    ##################################################################################################
    # Step 4: Look at subtracting channels 0 and 1
    print 'Step 4: Look at subtracting channels 0 and 1'
    v_4 = [x-y for x,y in zip(v700m_2,v180m_2)]
    plt.plot(time_ts,v_4)
    plt.show()
