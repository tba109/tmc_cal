...
def main():
    ...
    tmc_file = '../../raw/combo_pt100_ctrl_June2_2017/combo_3.txt'
    ...
    calref_time_tsig,calref_meas_tsig = tmc_parse_data_instr.tmc_parse_data(tmc_file,'TSIG'+'5','ADC'+'2')
    ...
    # Baseline
    bvcr_time,bvcr_meas = tmc_parse_data_instr.tmc_parse_data(tmc_file,'BSLN','ADC'+'2')
    bvcr_mvavg = moving_average(bvcr_meas,40)
    v_bvcr = [(x/8388608. - 1)*1.25 for x in bvcr_mvavg]
    ...
    f_bvcr = interpolate.interp1d(bvcr_time,v_bvcr)
